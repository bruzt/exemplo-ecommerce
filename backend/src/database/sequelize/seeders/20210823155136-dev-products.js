...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    for(let i=1; i<=15; i++){
      ...
      await ingestProduct(i, product.title);
    }
    ...
    for(let i=1; i<=15; i++){
      ...
      await ingestProduct(i + 15, product.title);
    }
    ...
    for(let i=1; i<=15; i++){
      ...
      await ingestProduct(i + 30, product.title);
    }
    ...
    for(let i=1; i<=15; i++){
      ...
      await ingestProduct(i + 45, product.title);
    }
    ...
    for(let i=1; i<=15; i++){
      ...
      await ingestProduct(i + 60, product.title);
    }
    ...
    for(let i=1; i<=15; i++){
      ...
      await ingestProduct(i + 75, product.title);
    }
    ...
    for(let i=1; i<=15; i++){
      ...
      await ingestProduct(i + 90, product.title);
    }
