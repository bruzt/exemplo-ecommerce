...
export const fakeJwtToken = {
  token:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiYWRtaW4iOnRydWUsImlhdCI6MTYzMDMyNTM0OSwiZXhwIjoxNjMwMzY4NTQ5fQ.qdMydkk75Zc797GIVWxMVLpKyElZn4PZJFsmcqskS1w",
};
