...
import { fakeUser, fakeCpfs, fakeAddress, fakeCreditCardOrder, fakeFreightPrice, fakeInstallments } from '../../../testUtils/fakeData';
...
describe('Credit Card Payment Tests', () => {
    ...
    it('should call api to pay with credit card', async () => {
        ...
        function mockSetDisable(value = true) { return value }
        ...
        fireEvent.change(cardExpirationYearInput, { target: { value: String(new Date().getFullYear()).substr(-2) }});
    ...
    it('should not call api to pay with credit card - street too small', async () => {
        ...
        fireEvent.change(neighborhoodInput, { target: { value: 'bairro bairroso' }});
