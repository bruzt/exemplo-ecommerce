...
export default function AccountGeneral() {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    const data = {
      name:
        getName.trim() == userContext.getUser.name ? undefined : getName.trim(),
      email:
        getEmail.trim() == userContext.getUser.email
          ? undefined
          : getEmail.trim(),
      cpf:
        getCpf.trim() == userContext.getUser.cpf
          ? undefined
          : getCpf.trim().replace(/\.|-/g, ""),
      currentPassword:
        getCurrentPassword.trim().length == 0
          ? undefined
          : getCurrentPassword.trim(),
      newPassword:
        getNewPassword.trim().length == 0 ? undefined : getNewPassword.trim(),
    };
            ...
            <div className="form-group">
              ...
              <input
                ...
                className={`${
                  ...
                  (formatCpf(getCpf).valid == false ? "invalid" : "valid")
                }`}
